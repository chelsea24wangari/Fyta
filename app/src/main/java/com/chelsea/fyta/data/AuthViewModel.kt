...
import com.chelsea.fyta.ui.navigations.ROUT_REGISTER
import com.chelsea.fyta.models.User
import com.chelsea.fyta.ui.navigations.ROUT_ADMIN
            ...
            mAuth.signInWithEmailAndPassword(email, password).addOnCompleteListener { task ->
                ...
                if (task.isSuccessful) {
                    ...
                    userRef.get().addOnSuccessListener { snapshot ->
                        ...
                        if (role == "admin") {
                            navController.navigate(ROUT_ADMIN)   // <-- change to your actual route
                        }
